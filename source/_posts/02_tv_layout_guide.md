---
title: TV Layout (Thread-Value Layout) 完全指南
date: 2024-12-24
categories: [CUDA, CuTe, CUTLASS]
tags: [layout, thread, value, mma]
---

# TV Layout (Thread-Value Layout) 完全指南

## 1. 引言

在 CuTe 中，TV Layout 是描述数据如何在多线程间分配的核心抽象。理解 TV Layout 是掌握 WGMMA 和 TMA 的关键。
...
### 5.4 图示：Thread 0 的 8 个位置

```
64×16 矩阵 (Column-Major):
...
```
    ...
    Thr 0     │  0  │  1  │  2  │...│ 64  │ 65  │...│
              ├─────┼─────┼─────┼───┼─────┼─────┼───┤
    Thr 1     │  0  │  1  │  2  │...│ 64  │ 65  │...│  ← 相同!
              ├─────┼─────┼─────┼───┼─────┼─────┼───┤
    Thr 2     │  0  │  1  │  2  │...│ 64  │ 65  │...│  ← 相同!
              └─────┴─────┴─────┴───┴─────┴─────┴───┘

所有线程看到相同的 offset → 通过同一个 SMEM descriptor 访问
```
